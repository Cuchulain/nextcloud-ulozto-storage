...
namespace OCA\UloztoStorageProvider\Tests\Integration\Controller;

use OCA\UloztoStorageProvider\Controller\NoteController;
...
class NoteIntegrationTest extends TestCase {
	...
	public function setUp(): void {
		$app = new App('uloztostorageprovider');
